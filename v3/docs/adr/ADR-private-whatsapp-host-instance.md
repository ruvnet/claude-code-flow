...
The exact finite selection accepts the existing 23 bridge tools and two private
approval names; it rejects broad prefixes, duplicates, unknown names and collisions.
